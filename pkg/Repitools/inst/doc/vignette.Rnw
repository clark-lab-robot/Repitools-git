...
binPlots(samplesList, geneAnno, design = designMatrix, by = 500, bw = 500, seqLen = 300, ordering = expr, plotType = "heatmap", nbins = 10)
@
...
binPlots(samplesList, geneAnno, design = designMatrix, by = 500, bw = 500, seqLen = 300, ordering = expr, plotType = "line", nbins = 10)
@
